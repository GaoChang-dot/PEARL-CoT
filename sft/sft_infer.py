...
def format_prompt(input_text: str, base_model_type: str) -> str:
...
def generate_response(
    ...
    prompt = format_prompt(input_text, base_model_type)
...
def run_inference(args):
    ...
    val_data_path = "../data/sft_dataset/sft_test.json"
    ...
    for i, example in enumerate(val_data):
        ...
        generated_output = generate_response(
            model, tokenizer, input_text, args.base_model_type
        )
    ...
    output_path = f"../data/sft_dataset/{args.base_model_type}_inference.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Inference with fine-tuned SFT model.")
